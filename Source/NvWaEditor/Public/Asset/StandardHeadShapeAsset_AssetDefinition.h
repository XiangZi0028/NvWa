...
#include "StandardHeadShapeAsset_AssetDefinition.generated.h"

UCLASS()
class NVWAEDITOR_API UStandardHeadShapeAsset_AssetDefinition : public UAssetDefinitionDefault
{
	GENERATED_BODY()
...
//方式2
class FStandardHeadShapeTypeActions : public FAssetTypeActions_AnimationAsset
{
public:
public:
